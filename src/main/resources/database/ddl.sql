...
CREATE TABLE IF NOT EXISTS `navigators_db`.`bus_route_points` (
  ...
  INDEX `fk_points_has_bus_routes_bus_routes1_idx` (`bus_route_id` ASC) VISIBLE,
  INDEX `fk_points_has_bus_routes_points1_idx` (`point_id` ASC) VISIBLE,
  PRIMARY KEY (`id`),
